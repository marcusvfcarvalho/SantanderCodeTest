...
```bash
dotnet run --project SantanderCodeTest\SantanderCodeTest\SantanderCodeTest.csproj
```

Access the API endpoint at /api/beststories to retrieve the best stories. Optionally, you can provide a limit parameter to specify the number of stories to fetch (default is 10).
## Configuration
